...
func _process(delta):
	...
	if (towns.town_select == "plansey"):
		...
		price_output.clear()
		price_output.add_text(str(price_check.plansey_arcade_two_price))
...
func _on_lower_button_down():
	...
	if (towns.town_select == "plansey"):
		if (price_check.plansey_arcade_two_price > 0):
			price_check.plansey_arcade_two_price = price_check.plansey_arcade_two_price - 1
