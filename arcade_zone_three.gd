...
func set_type():
	if town_select == "hollyhock":
		if (station_three_selection == 0):
			type = "none"
		if (station_three_selection == 1):
			type = "meta"
		if (station_three_selection == 2):
			type = "classic"
		if station_three_selection == 3:
			type = "platformer"
	
	
func get_globals():
	station_three_selection = global.station_three_selection
