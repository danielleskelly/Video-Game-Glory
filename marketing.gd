...
func _process(delta):
	if (global.town_select == "hollyhock"):
		advertising = global.hollyhock_advertising
	if (advertising == 0):
		ad_output.clear()
...
func _on_lower_button_down():
	if (global.town_select == "hollyhock"):
		if (global.hollyhock_advertising > 0):
			global.hollyhock_advertising = global.hollyhock_advertising - 1
			spending_output.clear()
			spending_output.add_text(str(global.hollyhock_advertising))
			global.hollyhock_expenses = global.hollyhock_expenses - 1


func _on_raise_button_down():
	if (global.town_select == "hollyhock"):
		if ((global.hollyhock_advertising + 1 <= global.hollyhock_cash) and (global.hollyhock_advertising + 1 <= global.hollyhock_advertising_max)):
			global.hollyhock_advertising = global.hollyhock_advertising + 1
			spending_output.clear()
			spending_output.add_text(str(global.hollyhock_advertising))
			global.hollyhock_expenses = global.hollyhock_expenses + 1