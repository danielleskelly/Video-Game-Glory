...
func _process(delta):
	...
	if (towns.town_select == "fiyork"):
		...
		if (customer_math.fiyork_genre_two_key == true):
			...
			get_node("genre_two_icon").set_texture(meta_icon)
			get_node("genre_two_icon").set_scale(Vector2(.35,.5))
		elif (customer_math.fiyork_genre_two_key == false):
			get_node("genre_two_icon").set_hidden(true)
			get_node("genre_one_background1").set_hidden(true)
		if (customer_math.fiyork_genre_three_key == true):
			...
			get_node("genre_three_icon").set_texture(meta_icon)
			get_node("genre_three_icon").set_scale(Vector2(.35,.5))
		elif (customer_math.fiyork_genre_three_key == false):
			get_node("genre_three_icon").set_hidden(true)
			get_node("genre_one_background2").set_hidden(true)
	if (towns.town_select == "plansey"):
		...
		if (customer_math.plansey_genre_two_key == true):
			...
			get_node("genre_two_icon").set_texture(meta_icon)
			get_node("genre_two_icon").set_scale(Vector2(.35,.5))
		elif (customer_math.plansey_genre_two_key == false):
			get_node("genre_two_icon").set_hidden(true)
			get_node("genre_one_background1").set_hidden(true)
		if (customer_math.plansey_genre_three_key == true):
			...
			get_node("genre_three_icon").set_texture(meta_icon)
			get_node("genre_three_icon").set_scale(Vector2(.35,.5))
		elif (customer_math.plansey_genre_three_key == false):
			get_node("genre_three_icon").set_hidden(true)
			get_node("genre_one_background2").set_hidden(true)