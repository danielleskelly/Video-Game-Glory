...
func get_globals():
	...
	worst_key = global.deus_worst_key
	decent_key = global.deus_decent_key
	good_key = global.deus_good_key
	great_key = global.deus_great_key
	best_key = global.deus_best_key
