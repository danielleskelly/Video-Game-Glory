...
func _on_worst_button_button_down():
	if (global.town_select == "hollyhock"):
		if (global.hollyhock_entertainment_worst_key == true):
			select_price = 0
			notifications.clear()
...
func _on_decent_button_button_down():
	if (global.town_select == "hollyhock"):
		if (global.hollyhock_entertainment_decent_key == true):
			select_price = 0
			notifications.clear()
			notifications.add_text("You already own that!")
			notifications.show()
		if (global.hollyhock_entertainment_decent_key == false):
...
func _on_good_button_button_down():
	if (global.town_select == "hollyhock"):
		if (global.hollyhock_entertainment_good_key == true):
			select_price = 0
			notifications.clear()
			notifications.add_text("You already own that!")
			notifications.show()
		if (global.hollyhock_entertainment_good_key == false):
...
func _on_great_button_button_down():
	if (global.town_select == "hollyhock"):
		if (global.hollyhock_entertainment_great_key == true):
			...
			notifications.add_text("You already own that!")
			notifications.show()
		if (global.hollyhock_entertainment_great_key == false):
...
func _on_best_button_button_down():
	if (global.town_select == "hollyhock"):
		if (global.hollyhock_entertainment_best_key == true):
			select_price = 0
			notifications.clear()
			notifications.add_text("You already own that!")
			notifications.show()
		if (global.hollyhock_entertainment_best_key == false):
...
func _on_confirm_button_down():
	...
	if (key_change == "hollyhock decent"):
		global.hollyhock_entertainment_decent_key = true
	if (key_change == "hollyhock good"):
		global.hollyhock_entertainment_good_key = true
	if (key_change == "hollyhock great"):
		global.hollyhock_entertainment_great_key = true
	if (key_change == "hollyhock best"):
		global.hollyhock_entertainment_best_key = true
	notifications.clear()