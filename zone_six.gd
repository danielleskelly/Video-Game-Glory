...
func _process(delta):
	...
	if (towns.town_select == "fiyork"):
		...
		price_output.clear()
		price_output.add_text(str(price_check.fiyork_arcade_six_price))
	if (towns.town_select == "plansey"):
		range_output.clear()
		range_output.add_text(str(price_check.plansey_arcade_range_low) + " - " + str(price_check.plansey_arcade_range_high))
		price_output.clear()
		price_output.add_text(str(price_check.plansey_arcade_six_price))
...
func _on_lower_button_down():
	...
	if (towns.town_select == "fiyork"):
		if (price_check.fiyork_arcade_six_price > 0):
			price_check.fiyork_arcade_six_price = price_check.fiyork_arcade_six_price - 1
	if (towns.town_select == "plansey"):
		if (price_check.plansey_arcade_six_price > 0):
			price_check.plansey_arcade_six_price = price_check.plansey_arcade_six_price - 1
