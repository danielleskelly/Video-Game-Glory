...
func _process(delta):
	if (global.town_select == "hollyhock"):
		...
		player_marketshare_output.add_text(str(global.hollyhock_player_marketshare))
		comp_one_marketshare_output.clear()
		comp_one_marketshare_output.add_text(str(global.hollyhock_competitor_one_marketshare))
		comp_two_marketshare_output.clear()
		comp_two_marketshare_output.add_text(str(global.hollyhock_competitor_two_marketshare))
	player_output.clear()
