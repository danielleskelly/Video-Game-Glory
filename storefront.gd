...
func get_globals():
	...
	worst_key = global.storefront_worst_key
	decent_key = global.storefront_decent_key
	good_key = global.storefront_good_key
	great_key = global.storefront_great_key
	best_key = global.storefront_best_key
