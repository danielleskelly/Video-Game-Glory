...
func _process(delta):
	...
	if (towns.town_select == "fiyork"):
		...
		if (fiyork.fiyork_arcade_sabatoge_key == false):
			get_node("not_opened").set_hidden(true)
	if (towns.town_select == "windrow"):
		if (windrow.windrow_arcade_sabatoge_key == true):
			get_node("not_opened").set_hidden(false)
		if (windrow.windrow_arcade_sabatoge_key == false):
			get_node("not_opened").set_hidden(true)
	if (towns.town_select == "slatten"):
		if (slatten.slatten_arcade_sabatoge_key == true):
			get_node("not_opened").set_hidden(false)
		if (slatten.slatten_arcade_sabatoge_key == false):
			get_node("not_opened").set_hidden(true)
	worst_output.clear()
...
func _on_worst_button_button_down():
	...
	if (towns.town_select == "plansey"):
		if (plansey.plansey_arcade_worst_key == true):
			...
			notifications.show()
	if (towns.town_select == "windrow"):
		if (windrow.windrow_arcade_worst_key == true):
			select_price = 0
			notifications.clear()
			notifications.add_text("You already own that!")
			notifications.show()
	if (towns.town_select == "banlon"):
		if (banlon.banlon_arcade_worst_key == true):
			select_price = 0
			notifications.clear()
			notifications.add_text("You already own that!")
			notifications.show()
	if (towns.town_select == "slatten"):
		if (slatten.slatten_arcade_worst_key == true):
			select_price = 0
			notifications.clear()
			notifications.add_text("You already own that!")
			notifications.show()
	if (towns.town_select == "untilly"):
		if (untilly.untilly_arcade_worst_key == true):
			select_price = 0
			notifications.clear()
			notifications.add_text("You already own that!")
			notifications.show()
	...
	if (select_price != 0):
		...
		if (towns.town_select == "windrow"):
			...
			if (key_change == "windrow decent"):
				windrow.windrow_arcade_decent_key = true
			if (key_change == "windrow good"):
				windrow.windrow_arcade_good_key = true
			if (key_change == "windrow great"):
				windrow.windrow_arcade_great_key = true
			if (key_change == "windrow best"):
				windrow.windrow_arcade_best_key = true
		if (towns.town_select == "banlon"):
			money.banlon_balance = money.banlon_balance - select_price
			if (key_change == "banlon decent"):
				banlon.banlon_arcade_decent_key = true
			if (key_change == "banlon good"):
				banlon.banlon_arcade_good_key = true
			if (key_change == "banlon great"):
				banlon.banlon_arcade_great_key = true
			if (key_change == "banlon best"):
				banlon.banlon_arcade_best_key = true
		if (towns.town_select == "slatten"):
			money.slatten_balance = money.slatten_balance - select_price
			if (key_change == "slatten decent"):
				slatten.slatten_arcade_decent_key = true
			if (key_change == "slatten good"):
				slatten.slatten_arcade_good_key = true
			if (key_change == "slatten great"):
				slatten.slatten_arcade_great_key = true
			if (key_change == "slatten best"):
				slatten.slatten_arcade_best_key = true
		if (towns.town_select == "untilly"):
			money.untilly_balance = money.untilly_balance - select_price
			if (key_change == "untilly decent"):
				untilly.untilly_arcade_decent_key = true
			if (key_change == "untilly good"):
				untilly.untilly_arcade_good_key = true
			if (key_change == "untilly great"):
				untilly.untilly_arcade_great_key = true
			if (key_change == "untilly best"):
				untilly.untilly_arcade_best_key = true
		notifications.clear()
	select_price = 0
